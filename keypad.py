...
class Keypad(object):
	def __init__(self, lines, cols, debounce_ms=300 ):
		...
		self.cols = [ Pin(pin_name, Pin.IN, Pin.PULL_UP) for pin_name in cols ] # Pin.PULL_UP = évite de faire trop d'ondulation lors du changement d'état
...
class Keypad4x4( Keypad ):
	def __init__( self, lines=[13,12,14,27], cols=[26,25,33,32], map="147*2580369#ABCD" ):
		self.map = map
